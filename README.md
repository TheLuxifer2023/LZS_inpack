...
**Инструмент для полной распаковки и упаковки 3D моделей и шрифтов из формата Phyre Engine** (PlayStation 3/4/Vita)
...
Процесс Reverse Engineering формата `PBitmapFont`:
